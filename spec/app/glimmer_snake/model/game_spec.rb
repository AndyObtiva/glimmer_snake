...
require 'app/glimmer_snake/model/game'

RSpec.describe GlimmerSnake::Model::Game do
  it 'has a grid of vertebrae of width of 20 and height of 20' do
    expect(subject).to be_a(GlimmerSnake::Model::Game)
  ...
  it 'starts game by generating snake and apple in random locations' do
    ...
    expect(subject.snake).to be_a(GlimmerSnake::Model::Snake)
    expect(subject.snake.length).to eq(1)
    expect(subject.snake.head).to be_a(GlimmerSnake::Model::Vertebra)
    ...
    expect(GlimmerSnake::Model::Vertebra::ORIENTATIONS).to include(subject.snake.head.orientation)
    expect(subject.snake.length).to eq(1)
    
    expect(subject.apple).to be_a(GlimmerSnake::Model::Apple)
